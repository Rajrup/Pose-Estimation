import sys
sys.path.append('./module_pose')
from tracker import PoseTracker
from multi_classifier import MultiPersonClassifier

MODEL_PATH = "./models/pose_recognition/trained_classifier.pickle"
...
class PoseRecognition:
  ...
  def Setup():
    ...
    PoseRecognition.multiperson_classifier = MultiPersonClassifier(MODEL_PATH, ['stand', 'walk', 'run', 'jump', 'sit', 'squat', 'kick', 'punch', 'wave'])
